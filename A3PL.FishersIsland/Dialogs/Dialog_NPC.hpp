...
class Dialog_NPC
{
	...
	{	
		////////////////////////////////////////////////////////
		// GUI EDITOR OUTPUT START (by Kane, v1.063, #Wicyqy)
		////////////////////////////////////////////////////////
		...
		{
			idc = 1600;
			text = "1. Hey! I would like to start working at mcfishers."; //--- ToDo: Localize;
		...
		{
			idc = 1601;
			text = "2. I am hungry, I would like to buy food."; //--- ToDo: Localize;
			x = 0.453594 * safezoneW + safezoneX;
